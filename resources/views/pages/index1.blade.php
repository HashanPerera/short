...
<body>
						...
						<ul id="navwrap">
							...
							<li><a href="#">Clothing</a>
								<div class="Mega_menu"><!-- start of Mega_menu -->
									...
									<ul>
										<li><a href="#"><img src="{{asset('frontEnd')}}/images/mega_pic.jpg" alt="mega_menu_img" class="img-responsive"/></a></li>
									</ul>
	...
	<div class="homepage_slider_area"><!-- start of homepage_slider_area -->
		<div class="homepage_slides owl-carousel">
			...
			<div class="single_slide_item slide_bg_1" style="background-image: url({{asset('frontEnd')}}/images/slider4.jpg);"><!-- start of single_slide_item -->
				<div class="single_item_table">
					<div class="slide_item_tablecell">
						<div class="container">
							<div class="row tex">
		...
		<div class="row">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="login">
						<img src="{{asset('frontEnd')}}/images/banner10.jpg" alt="">
				...
				<div class="col-md-3">
					...
					<div class="footer_account"><!-- start of footer_account -->
						<ul>
							...
							<li><a href="/sign">Registration</a></li>
