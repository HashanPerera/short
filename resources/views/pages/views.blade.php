...
<link rel="stylesheet" type="text/css" href="{{asset('frontEnd')}}/css/bootstrap.min.css" media="all" />
	...
	<link rel="stylesheet" type="text/css" href="{{asset('frontEnd')}}/css/1.css" media="all" />
			...
			<div class="row">
				<div class="col-md-3 col-sm-3">
					<div class="logo"><!-- start of logo -->
						<img src="{{asset('frontEnd')}}/images/aa2.jpg" alt="logo"/>
					</div><!-- End of logo -->
				</div>
				<div class="col-md-9 col-sm-9 text-right">
                    ...
                    <div class="header_right_area"><!-- start of header_right_area -->
						...
						<div class="heada1">
							<a href="/"><img src="{{asset('frontEnd')}}/images/logo1.jpg"></a>
						<!-- End of logo -->
					</div>
					<div class="heada1">
						<a href="/"><img src="{{asset('frontEnd')}}/images/logo1.jpg"></a>
